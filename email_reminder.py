...
if today_date==date_ldm2:
 ...
 FROM = "abhishekara10@gmail.com"

 TO = ["1stadress@gmail.com","2ndaddress","etc"] # must be a list
 ...
 username = str("abhishekara10@gmail.com.com") 

 password = str("abhishek98")

 

 server = smtplib.SMTP("smtp.mail.gmail.com",587,timeout=10)
...
#if today si not workday -2 do nothing !
